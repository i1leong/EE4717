...
<body>
    <div class="wrapper">
        ...
        <div class="nav_bar_landing">
            <nav class="navbar">
                <ul class="topnav">
                    <li class="left"><a href="admin.php">Schedule</a></li>
                    <li><a>|</a></li>
        ...
        <div class="register">
            ...
            <form action="" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="number" name="height" id="height" value="<?php echo $GLOBALS["height"];?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <textarea type="textarea" name="existing_conditions" id="existing_conditions"
                            size="300px"><?php echo $GLOBALS["existing_condition"];?></textarea>
                    </div>
                </div>
